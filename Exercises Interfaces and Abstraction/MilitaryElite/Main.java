package Exercise_InterfacesAndAbstraction.MilitaryElite;

import Exercise_InterfacesAndAbstraction.MilitaryElite.classes.*;
import Exercise_InterfacesAndAbstraction.MilitaryElite.interfaces.*;
...
public class Main {
    ...
    private static void createCommando() throws Exception {
        ...
        for (int i = 6; i < data.length; i += 2) {
            ...
            try {
                Missions mission = new MissionImpl(codeName, state);
